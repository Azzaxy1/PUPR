        ...
        <table class="table table-hover mb-0">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>{{ optional($report->transactions->where('status_active',1)->last()->approve_dates)->format('d/m/Y H:i') ?? '-' }}</td>
              <td class="text-center">
                <a href="{{ route('petugas.final.pdf', $report->id) }}" class="btn btn-sm btn-outline-danger me-1">
                  <i class="fas fa-file-pdf"></i> PDF
                </a>
                <a href="{{ route('petugas.pengaduan.edit', $report->id) }}" class="btn btn-sm btn-outline-primary">
