          ...
          <form action="{{ route('petugas.users.store') }}" method="POST">
            ...
            <div class="mb-3">
              ...
              <select name="m_role_tab_id" class="form-select" required>
                ...
                @foreach(\App\Models\MRoleTab::all() as $role)
                  <option value="{{ $role->id }}" {{ old('m_role_tab_id')==$role->id?'selected':'' }}>{{ $role->title }}</option>
                @endforeach
              </select>
            </div>
            <div class="mb-3">
            ...
            <div class="row">
              <div class="col-md-6 mb-3">
                ...
                <input type="text" name="number_identification" class="form-control" value="{{ old('number_identification') }}" required>
              </div>
              <div class="col-md-6 mb-3">
              ...
              <div class="col-md-6 mb-3">
                ...
                <input type="text" name="working" class="form-control" value="{{ old('working') }}">
              </div>
              <div class="col-md-6 mb-3">
                <label class="form-label">Alamat Kantor</label>
                <input type="text" name="address_office" class="form-control" value="{{ old('address_office') }}">
              </div>
            </div>
            <div class="text-end">
